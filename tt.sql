...
SELECT @bool;
--------------------------------------------------------------------------------------------------------------
CREATE OR ALTER VIEW Movimientos_Gestion_Auditor AS
SELECT 
    id_bitacora,
    id_ets,
    fecha_aplicacion,
    ...
    fecha_ejecuta,
    tip_ejec,
    NULL AS id_ets_plan_uni_apren_est_car,
    NULL AS id_plan,
    NULL AS id_uni_apren_inscrita,
    NULL AS id_est,
    NULL AS id_carrera,
	NULL AS nom_carrera,
	NULL AS total_creditos,
	NULL AS nombre_plan,
	NULL AS id_uni_apren_equi,
	NULL AS id_creditos,
	NULL AS nom_uni_apren,
	NULL AS id_grupo_est,
	NULL AS id_grupo,
    NULL AS id_uni_apren,
	NULL AS id_grupo,
	NULL AS nom_grupo,
	NULL AS id_estudiante_carrera,
	NULL AS id_est,
	NULL AS id_carrera,
	NULL AS id_est_tip_sol_bit_gestion,
	NULL AS id_est,
	NULL AS id_tipo_solicitud,
	NULL AS id_bitacora,
	NULL AS id_bitacora,
	NULL AS fecha_resgistro_bd,
	NULL AS fecha_solicitud,
	NULL AS fecha_entrega,
	NULL AS estado,
	NULL AS id_bitacora_bitacora,
	NULL AS id_uni_apren_inscrita,
	NULL AS id_est,
	NULL AS id_user_ejecuta,
	NULL AS fecha_ejecuta,
	NULL AS tip_ejec,
	NULL AS id_bitacora_bitacora,
	NULL AS id_rol,
	NULL AS nombre_rol,
	...
	NULL AS tip_ejec,
	NULL AS id_bitacora_bitacora,
	NULL AS id_uni_apren_desfasada,
	NULL AS id_uni_apren,
	NULL AS id_est,
	NULL AS id_user_ejecuta,
	NULL AS fecha_ejecuta,
	NULL AS tip_ejec,
	NULL AS id_bitacora_bitacora,
	NULL AS id_rol_personal_usuario,
	NULL AS id_personal,
	NULL AS id_rol,
	NULL AS id_usuario,
	NULL AS id_user_ejecuta,
	...
	NULL AS id_expediente_est,
	NULL AS id_est,
	NULL AS id_tipo_solicitud,
	NULL AS ruta,
	NULL AS id_bitacora_bitacora,
	NULL AS id_rol_usuario_est,
	NULL AS id_rol,
	NULL AS id_usuario,
	NULL AS id_est,
	NULL AS id_user_ejecuta,
	NULL AS fecha_ejecuta,
	NULL AS tip_ejec,
	NULL AS id_uni_apren_reprobada,
	NULL AS id_uni_apren,
	NULL AS id_est,
	NULL AS id_depto,
    NULL AS id_puesto,
	...
	NULL AS id_personal,
	NULL AS id_depto,
	NULL AS nombre_depto,
	NULL AS id_bitacora_bitacora,
	NULL AS id_uni_apren_cursada,
	NULL AS id_uni_apren,
	NULL AS id_est,
	NULL AS id_user_ejecuta,
	NULL AS fecha_ejecuta,
...
FROM bit_ets_plan_uni_apren_est_car
UNION
SELECT 
    id_bitacora,
    NULL AS id_ets,
...
FROM bit_est_tip_sol_bit_gestion
UNION
SELECT 
    NULL AS id_bitacora,
    NULL AS id_ets,
...
FROM bit_depto_personal_puesto
UNION
SELECT 
   NULL AS id_bitacora,
   NULL AS id_ets,
